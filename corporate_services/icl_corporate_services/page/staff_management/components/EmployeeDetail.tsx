          ...
          <div className="col-md-8">
            ...
            <div className="frappe-card p-3 mb-3">
              ...
              {data.leave_applications.length === 0 ? (
                <div className="text-muted" style={{ fontSize: 13 }}>
                  No leave applications in the last 12 months.
                </div>
              ) : (
                <div className="table-responsive">
            ...
            <div className="frappe-card p-3 mb-3">
              <div className="d-flex align-items-center justify-content-between mb-3">
                ...
                <button
                  ...
                  className="btn btn-default btn-xs"
                  onClick={() =>
                    (globalThis as any).frappe?.set_route("timesheet-workflow", "employee", employee)
                  }
                >
                  View in Workflow
                </button>
            ...
            <div className="frappe-card p-3 mb-3">
              ...
              {data.travel_reconciliations.length === 0 ? (
                <div className="text-muted" style={{ fontSize: 13 }}>
                  No travel reconciliations found.
                </div>
              ) : (
                <div className="table-responsive">
                  <table className="table table-sm table-hover mb-0" style={{ fontSize: 13 }}>
            ...
            <div className="frappe-card p-3 mb-3">
              ...
              {data.travel_requests.length === 0 ? (
                <div className="text-muted" style={{ fontSize: 13 }}>
                  No travel requests in the last 12 months.
                </div>
              ) : (
                <div className="table-responsive">
                  <table className="table table-sm table-hover mb-0" style={{ fontSize: 13 }}>
